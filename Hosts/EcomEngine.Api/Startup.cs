...
using EcomEngine.Api.Configurations;
...
namespace EcomEngine.Api
{
    public class Startup
    {
        ...
        private const string API_NAME = "EcomEngine";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
			...
			services.AddHealthChecks().AddDbContextCheck<EcomEngineDb>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            // Check the port in EcomEngine.Spa -> Properties -> launchSettings.json and update EcomEngine.Api -> appsettings.json -> WhiteList entry
